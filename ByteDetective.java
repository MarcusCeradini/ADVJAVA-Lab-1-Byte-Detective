...
public class ByteDetective {
    ...
    public static void readAllBytes() {
        ...
        int b = 0;
        try (FileInputStream fis = new FileInputStream("mystery.bin")) {
            ...
            //         - Increment counter
            while ((b = fis.read()) != -1) {
                System.out.println("Byte " + counter + ": " + b);
                counter++;
            }

            // TODO: After loop, print total count
            System.out.println("Total bytes read: " + (counter - 1));
    ...
    public static void displayAsHex() {
        ...
        try (FileInputStream fis = new FileInputStream("mystery.bin")) {
            while ((bytes = fis.read()) != -1) {
                Object byteValue = bytes;
                String formated = String.format("%02X ", byteValue);
